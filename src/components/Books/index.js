...
const Books = () => {
	return (
		<div className="grid grid-cols-2 w-full">
			...
			<div className='bg-[#FEFBEE] p-16 flex flex-col gap-4 justify-center'>
				<div className='text-5xl font-bold text-[#007BFF] mb-8'>IL books <span className='text-[#080E14]'>for NEET</span></div>
				<div className='text-2xl text-[#080E14] font-bold'>Botany class 11 <span className='text-lg font-normal text-[#6B6E72]'>(12 books)</span></div>
