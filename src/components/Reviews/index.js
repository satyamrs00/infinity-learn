...
const Reviews = () => {
	return (
		<div className='w-full'>
			<div className="bg-[#00364E] p-16 w-full text-white">
				<div className="text-5xl font-bold text-center mb-12">reviews and <span className="text-[#FCDE5A]">results</span></div>
			...
			<div className='grid grid-cols-3 gap-4 -mt-52 justify-center mb-8 px-20'>
				<div className='bg-white rounded-xl p-4 shadow-[0px_7px_10px_0px_#9AA0D34D]'>
			...
			<div className='flex gap-2 mt-2 px-20 justify-end mb-12'>
			...
			<div className='px-20 overflow-y-auto no-scrollbar flex gap-8 mb-20'>
